...
<Steps>
  <Step title="Head over to your Discord Server">
    Click on the Discord Server where you want to set up the jail system using your bot, Evict.
  </Step>
  <Step title="Configuring Jail">
    - Run the command `,setme` in any channel.
    - This command will automatically create a channel called `jail`, a category named `Evict Mod` and a mod-logs channel.
    - You can customize the name of the channels if needed.

    <Frame caption="Creating jail channel & role.">
     <img src="/images/moderation/jail/setme.gif" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Configuring Jail">
    ...
    <Frame caption="Example of jailing a user.">
     <img src="/images/moderation/jail/jail.gif" />
    </Frame>
  </Step>
    <Step title="Unjaling a user">
    - Run the command `;unjail <user>` for example `;unjail @x6ur` in any channel.
    - This command will automatically unjail the mentioned user.

    <Frame caption="Example of unjailing a user.">
     <img src="/images/moderation/jail/unjail.gif" />
    </Frame>
  </Step>
</Steps>